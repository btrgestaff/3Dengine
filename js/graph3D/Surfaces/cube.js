Surfaces.prototype.cube = (x = 0, y = 0, z = 0, size = 10) => {
    return new Subject([
        ...
        new Polygon([0, 1, 2, 3], 'green'), new Polygon([0, 4, 7, 3], 'red'), new Polygon([0, 4, 5, 1], 'yellow'),
        new Polygon([1, 2, 6, 5], 'blue'), new Polygon([2, 3, 7, 6], 'black'), new Polygon([4, 5, 6, 7], 'purple')
    ]);
}
